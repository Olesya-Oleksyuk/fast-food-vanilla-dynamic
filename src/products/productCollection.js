import { PRODUCT_CATEGORIES } from "../components/productNav/constants";
import { Observable } from "../utils/utils";
import ProductModel from "./product";

export default class ProductCollectionModel extends Observable {
  #products;
  /**
  ...
  getFilteredProducts() {
    return this.#products.filter(item => item.category === this.categoryFilter);
  }
